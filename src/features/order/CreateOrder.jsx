      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col sm:flex-row sm:items-center gap-2">
          ...
          <div className="grow">
            ...
            {formErrors?.phone && (
              <p className="mt-2 text-xs text-red-800 bg-red-100 p-2 rounded-md">
                {formErrors.phone}
              </p>
            )}
          </div>
        ...
        <div className="relative mb-5 flex flex-col sm:flex-row sm:items-center gap-2">
        ...
        <div>
          ...
          <Button disabled={isSubmmitting || isLoadingAddress} type="primary">
            {isSubmmitting ? "Placing order..." : `Order now from ${formatCurrency(totalPrice)}`}
          </Button>
        </div>
      </Form>
    </div>
